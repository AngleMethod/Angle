    ...
    <div className={s.site}>
      ...
      <main id="main-content">
        <section id="hero" className={s.hero}>
          ...
          <div className={s.heroBottom}><span>01 — A NEW PERSPECTIVE</span><a href="#journey">EXPLORE THE METHOD ↓</a><span>STRENGTH / BALANCE / CONTROL</span></div>
        </section>

        <div className={s.principles}><span>Built around your body.</span><span>Led by a clear method.</span><span>Made for your next breakthrough.</span><span className={s.accent}>THIS IS ANGLE. ↗</span></div>
      ...
      <footer className={s.footer}><a href="#hero" aria-label="Back to top"><Image src="/angle-logo-footer-black.svg" alt="Angle" width={800} height={240} /></a><div><span>© {new Date().getFullYear()} Angle</span><span>MASTER HANDSTANDS WITH TECHNICAL PRECISION</span><a href="#hero">BACK TO TOP ↑</a></div></footer>
